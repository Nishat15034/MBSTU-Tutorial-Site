...
<body class=" sidebar_main_open sidebar_main_swipe">
                ...
                <div class="uk-navbar-flip">
                    <ul class="uk-navbar-nav user_actions">
                        <li data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                            <a href="#" class="user_action_image"><img class="md-user-image" src="{{url('assets/img/1.jpg')}}" alt=""/></a>
                            <div class="uk-dropdown uk-dropdown-small">
                                <ul class="uk-nav js-uk-prevent">
                                    <li><a href="{{ url('admin/logout') }}" method="post">Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
    ...
    @if(Session::has('flash_message'))
        <div class="uk-width-medium-1-1">
            <div style="margin-left: 238px!important;"  class="uk-alert uk-alert-{{session('flash_notification')}}" data-uk-alert>
            ...
            <ul>
                ...
                <li title="Users">
                    ...
                    <ul>
                        ...
                        <li><a href="{{url('admin/user/pending')}}">Pending Users</a></li>
                    </ul>
                ...
                <li title="Course">
                    <a href="{{url('admin/course')}}">
                        ...
                        <span class="menu_title">Course</span>
                    </a>
                </li>
                @endif
                <li title="Category">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">layers</i></span>
                ...
                <li title="Topic">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">blur_circular</i></span>
                        <span class="menu_title">Topic</span>
                    </a>
                    <ul>
                        <li><a href="{{url('admin/topic')}}">Topic</a></li>
                        <li><a href="{{url('admin/topic-content')}}">Topic Content</a></li>
                    </ul>
                ...
                <li title="Subscriber">
                    <a href="#">
                        ...
                        <span class="menu_title">Subscriber</span>
                    </a>
                    <ul>
                        <li><a href="{{url('admin/subscribers')}}">All Subscriber</a></li>
                        <li><a href="{{url('admin/subscribers/message')}}">Send Message</a></li>
                    </ul>
                
                </li>
                <li title="Message">
                    <a href="{{url('admin/messages')}}">
                        <span class="menu_icon"><i class="material-icons">mail</i></span>
